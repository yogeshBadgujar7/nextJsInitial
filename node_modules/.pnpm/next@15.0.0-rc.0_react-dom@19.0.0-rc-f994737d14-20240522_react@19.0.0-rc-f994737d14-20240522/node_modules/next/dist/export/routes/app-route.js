...
const _isstaticgenenabled = require("../../server/future/route-modules/app-route/helpers/is-static-gen-enabled");
...
async function exportAppRoute(req, res, params, page, incrementalCache, distDir, htmlFilepath, fileWriter, experimental) {
    ...
    try {
        ...
        const isMetadataRoute = (0, _ismetadataroute.isStaticMetadataRoute)(normalizedPage) || (0, _ismetadataroute.isMetadataRouteFile)(`${normalizedPage}.ts`, [
            'ts'
        ], true);
        if (!(0, _isstaticgenenabled.isStaticGenEnabled)(userland) && !isMetadataRoute) {
            return {
                revalidate: 0
            };
        }
