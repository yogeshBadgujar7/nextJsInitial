...
export async function buildAppStaticPaths({ dir, page, distDir, configFileName, generateParams, isrFlushToDisk, cacheHandler, requestHeaders, maxMemoryCacheSize, fetchCacheKeyPrefix, ComponentMod }) {
        ...
        if (typeof (pageEntry == null ? void 0 : pageEntry.getStaticPaths) === 'function') {
            ...
            const buildParams = async (paramsItems = [
                ...
                if (curGenerate.generateStaticParams) {
                    const curStore = ComponentMod.staticGenerationAsyncStorage.getStore();
                    if (curStore) {
                        var _curGenerate_config, _curGenerate_config1, _curGenerate_config2;
                        if (typeof (curGenerate == null ? void 0 : (_curGenerate_config = curGenerate.config) == null ? void 0 : _curGenerate_config.fetchCache) !== 'undefined') {
                            curStore.fetchCache = curGenerate.config.fetchCache;
                        }
                        if (typeof (curGenerate == null ? void 0 : (_curGenerate_config1 = curGenerate.config) == null ? void 0 : _curGenerate_config1.revalidate) !== 'undefined') {
                            curStore.revalidate = curGenerate.config.revalidate;
                        }
                        if ((curGenerate == null ? void 0 : (_curGenerate_config2 = curGenerate.config) == null ? void 0 : _curGenerate_config2.dynamic) === 'force-dynamic') {
...
export async function isPageStatic({ dir, page, distDir, configFileName, runtimeEnvConfig, httpAgentOptions, locales, defaultLocale, parentId, pageRuntime, edgeInfo, pageType, originalAppPath, isrFlushToDisk, maxMemoryCacheSize, cacheHandler, pprConfig }) {
