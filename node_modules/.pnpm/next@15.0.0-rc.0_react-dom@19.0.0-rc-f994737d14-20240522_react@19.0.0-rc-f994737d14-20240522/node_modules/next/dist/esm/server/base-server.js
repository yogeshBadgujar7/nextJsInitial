...
import { handleBadRequestResponse, handleInternalServerErrorResponse } from './future/route-modules/helpers/response-handlers';
...
export default class Server {
   ...
   */ this.normalize = (pathname)=>{
        ...
        const isAppPPREnabled = this.enabledDirectories.app && checkIsAppPPREnabled(this.nextConfig.experimental.ppr);
        this.normalizers = {
            // We should normalize the pathname from the RSC prefix only in minimal
            // mode as otherwise that route is not exposed external to the server as
            // we instead only rely on the headers.
            postponed: isAppPPREnabled && this.minimalMode ? new PostponedPathnameNormalizer() : undefined,
            rsc: this.enabledDirectories.app && this.minimalMode ? new RSCPathnameNormalizer() : undefined,
            prefetchRSC: isAppPPREnabled && this.minimalMode ? new PrefetchRSCPathnameNormalizer() : undefined,
   ...
   */ async prepare() {
     ...
     */ const couldSupportPPR = typeof routeModule !== 'undefined' && isAppPageRouteModule(routeModule) && this.renderOpts.experimental.isAppPPREnabled;
