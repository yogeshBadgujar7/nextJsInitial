...
export const StaticGenerationAsyncStorageWrapper = {
     ...
     */ const isStaticGeneration = !renderOpts.supportsDynamicHTML && !renderOpts.isDraftMode && !renderOpts.isServerAction;
        const prerenderState = isStaticGeneration && ((_renderOpts_experimental = renderOpts.experimental) == null ? void 0 : _renderOpts_experimental.isRoutePPREnabled) ? createPrerenderState(renderOpts.isDebugPPRSkeleton) : null;
        const store = {
            isStaticGeneration,
            urlPathname,
