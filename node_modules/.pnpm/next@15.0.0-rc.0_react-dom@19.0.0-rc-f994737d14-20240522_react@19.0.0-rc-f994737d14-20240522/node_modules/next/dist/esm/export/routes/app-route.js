...
export async function exportAppRoute(req, res, params, page, incrementalCache, distDir, htmlFilepath, fileWriter, experimental) {
    ...
    try {
        ...
        const isMetadataRoute = isStaticMetadataRoute(normalizedPage) || isMetadataRouteFile(`${normalizedPage}.ts`, [
            'ts'
        ], true);
