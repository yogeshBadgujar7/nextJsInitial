...
Try changing the value to '${Math.ceil(e.revalidate)}' or using \`Math.ceil()\` if you're computing the value.`)}else if(!0===e.revalidate)t=1;else if(!1===e.revalidate||void 0===e.revalidate)t=!1;else throw Error(`A page's revalidate option must be seconds expressed as a natural number. Mixed numbers and strings cannot be used. Received '${JSON.stringify(e.revalidate)}' for ${n.url}`)}else t=!1;if(m.pageProps=Object.assign({},m.pageProps,"props"in e?e.props:void 0),v.revalidate=t,v.pageData=m,v.isNotFound)return new ej(null,{metadata:v})}if(M&&(m[j.uY]=!0),M&&!ep){let e;let r=!0,o=s,d=!1;o=new Proxy(s,{get:function(e,n){if(!r){let e=`You should not access 'res' after getServerSideProps resolves.
Read more: https://nextjs.org/docs/messages/gssp-no-mutating-res`;if(d)throw Error(e);t(e)}return eW.g.get(e,n,s)}});try{e=await (0,en.getTracer)().trace(eo.xj.getServerSideProps,{spanName:`getServerSideProps ${a}`,attributes:{"next.route":a}},async()=>M({req:n,res:o,query:i,resolvedUrl:l.resolvedUrl,...ex?{params:F}:void 0,...!1!==h?{draftMode:!0,preview:!0,previewData:h}:void 0,locales:l.locales,locale:l.locale,defaultLocale:l.defaultLocale})),r=!1}catch(e){throw"object"==typeof e&&null!==e&&"name"in e&&"message"in e&&"ENOENT"===e.code&&delete e.code,e}if(null==e)throw Error(C.Lx);e.props instanceof Promise&&(d=!0);let u=Object.keys(e).filter(e=>"props"!==e&&"redirect"!==e&&"notFound"!==e);if(e.unstable_notFound)throw Error(`unstable_notFound has been renamed to notFound, please update the field to continue. Page: ${a}`);if(e.unstable_redirect)throw Error(`unstable_redirect has been renamed to redirect, please update the field to continue. Page: ${a}`);if(u.length)throw Error(eY("getServerSideProps",u));if("notFound"in e&&e.notFound){if("/404"===a)throw Error('The /404 page can not return notFound in "getStaticProps", please remove it to continue!');return v.isNotFound=!0,new ej(null,{metadata:v})}if("redirect"in e&&"object"==typeof e.redirect&&(eK(e.redirect,n,"getServerSideProps"),e.props={__N_REDIRECT:e.redirect.destination,__N_REDIRECT_STATUS:er(e.redirect)},void 0!==e.redirect.basePath&&(e.props.__N_REDIRECT_BASE_PATH=e.redirect.basePath),v.isRedirect=!0),d&&(e.props=await e.props),(w||ef)&&!N(a,"getServerSideProps",e.props))throw Error("invariant: getServerSideProps did not return valid props. Please report this.");m.pageProps=Object.assign({},m.pageProps,e.props),v.pageData=m}if(!em&&!M&&Object.keys((null==m?void 0:m.pageProps)||{}).includes("url")&&console.warn(`The prop \`url\` is a reserved prop in Next.js for legacy reasons and will be overridden on page ${a}
See more info here: https://nextjs.org/docs/messages/reserved-page-prop`),D&&!em||v.isRedirect)return new ej(JSON.stringify(m),{metadata:v});if(ep&&(m.pageProps={}),V(s)&&!em)return new ej(null,{metadata:v});let e2=E;if(ew&&ex){let e;let t=(e=(function(e){let t=/^\/index(\/|$)/.test(e)&&!G(e)?"/index"+e:"/"===e?"/index":B(e);{let{posix:e}=r("path"),n=e.normalize(t);if(n!==t)throw new Q("Requested and resolved page mismatch: "+t+" "+n)}return t})(a).replace(/\\/g,"/")).startsWith("/index/")&&!G(e)?e.slice(6):"/index"!==e?e:"/";t in e2.pages&&(e2={...e2,pages:{...e2.pages,[t]:[...e2.pages[t],...e2.lowPriorityFiles.filter(e=>e.includes("_buildManifest"))]},lowPriorityFiles:e2.lowPriorityFiles.filter(e=>!e.includes("_buildManifest"))})}let e3=({children:e})=>eO?e:(0,y.jsx)("div",{id:"__next",children:e}),e8=async()=>{let e,t;async function r(e){let t=async(t={})=>{if(e0.err&&$)return e&&e(ea,ec),{html:await eX((0,y.jsx)(e3,{children:(0,y.jsx)($,{error:e0.err})})),head:eI};if(w&&(m.router||m.Component))throw Error("'router' and 'Component' can not be returned in getInitialProps from _app.js https://nextjs.org/docs/messages/cant-override-next-props");let{App:r,Component:n}="function"==typeof t?{App:ea,Component:t(ec)}:{App:t.enhanceApp?t.enhanceApp(ea):ea,Component:t.enhanceComponent?t.enhanceComponent(ec):ec},o=await e(r,n);return await o.allReady,{html:await ei(o),head:eI}},r={...e0,renderPage:t},n=await X(eu,r);if(V(s)&&!em)return null;if(!n||"string"!=typeof n.html)throw Error(`"${J(eu)}.getInitialProps()" should resolve to an object with a "html" prop set with a valid html string`);return{docProps:n,documentCtx:r}}eu[j.wU];let n=(e,t)=>{let r=e||ea,n=t||ec;return e0.err&&$?(0,y.jsx)(e3,{children:(0,y.jsx)($,{error:e0.err})}):(0,y.jsx)(e3,{children:(0,y.jsx)(eV,{children:eZ(r,n,{...m,router:eP})})})},o=async(e,t)=>{let r=n(e,t);return await function({ReactDOMServer:e,element:t,streamOptions:r}){return(0,en.getTracer)().trace(eo.k0.renderToReadableStream,async()=>e.renderToReadableStream(t,r))}({ReactDOMServer:P(),element:r})},a=!!eu.getInitialProps,[i,l]=await Promise.all([eX(e4()),(async()=>{if(a){if(null===(e=await r(o)))return null;let{docProps:t}=e;return t.html}{e={};let t=await o(ea,ec);return await t.allReady,ei(t)}})()]);if(null===l)return null;let{docProps:d}=e||{};return a?(t=d.styles,eI=d.head):(t=eE.styles(),eE.flush()),{contentHTML:i+l,documentElement:e=>(0,y.jsx)(eu,{...e,...d}),head:eI,headTags:[],styles:t}};null==(u=(0,en.getTracer)().getRootSpanAttributes())||u.set("next.route",l.page);let e9=await (0,en.getTracer)().trace(eo.xj.renderDocument,{spanName:`render route (pages) ${l.page}`,attributes:{"next.route":l.page}},async()=>e8());if(!e9)return new ej(null,{metadata:v});let e6=new Set,e7=new Set;for(let e of eH){let t=T[e];t&&(e6.add(t.id),t.files.forEach(e=>{e7.add(e)}))}let e5=eL.hybrid,te={},{assetPrefix:tt,buildId:tr,customServer:tn,defaultLocale:to,disableOptimizedLoading:ts,domainLocales:ta,locale:ti,locales:tl,runtimeConfig:td}=l,tu={__NEXT_DATA__:{props:m,page:a,query:i,buildId:tr,assetPrefix:""===tt?void 0:tt,runtimeConfig:td,nextExport:!0===e1||void 0,autoExport:!0===ew||void 0,isFallback:ep,isExperimentalCompile:et,dynamicIds:0===e6.size?void 0:Array.from(e6),err:l.err?(p=l.err,w?(g="server",g=p[eG]||"server",{name:p.name,source:g,message:eT()(p.message),stack:p.stack,digest:p.digest}):{name:"Internal Server Error.",message:"500 - Internal Server Error.",statusCode:500}):void 0,gsp:!!I||void 0,gssp:!!M||void 0,customServer:tn,gip:!!ev||void 0,appGip:!eg||void 0,locale:ti,locales:tl,defaultLocale:to,domainLocales:ta,isPreview:!0===f||void 0,notFoundSrcPage:eh&&w?eh:void 0},strictNextHead:l.strictNextHead,buildManifest:e2,docComponentsRendered:te,dangerousAsPath:eP.asPath,canonicalBase:!l.ampPath&&ee(n,"didStripLocale")?`${l.canonicalBase||""}/${l.locale}`:l.canonicalBase,ampPath:S,inAmpMode:eO,isDevelopment:!!w,hybridAmp:e5,dynamicImports:Array.from(e7),assetPrefix:tt,unstable_runtimeJS:void 0,unstable_JsPreload:R.unstable_JsPreload,assetQueryString:ed,scriptLoader:eC,locale:ti,disableOptimizedLoading:ts,head:e9.head,headTags:e9.headTags,styles:e9.styles,crossOrigin:l.crossOrigin,optimizeCss:l.optimizeCss,optimizeFonts:l.optimizeFonts,nextConfigOutput:l.nextConfigOutput,nextScriptWorkers:l.nextScriptWorkers,runtime:K,largePageDataBytes:l.largePageDataBytes,nextFontManifest:l.nextFontManifest},tc=(0,y.jsx)(L.Provider,{value:eL,children:(0,y.jsx)(Z.Provider,{value:tu,children:e9.documentElement(tu)})}),tp=await (0,en.getTracer)().trace(eo.xj.renderToString,async()=>eX(tc));{let e=[];for(let t of["Main","Head","NextScript","Html"])te[t]||e.push(t);if(e.length){let t=e.map(e=>`<${e} />`).join(", "),r=1!==e.length?"s":"";console.warn(`Your custom Document (pages/_document) did not render all the required subcomponent${r}.
Missing component${r}: ${t}
Read how to fix here: https://nextjs.org/docs/messages/missing-document-component`)}}let[th,tm]=tp.split("<next-js-internal-body-render-target></next-js-internal-body-render-target>",2),tf="";tp.startsWith(eJ)||(tf+=eJ),tf+=th,eO&&(tf+="<!-- __NEXT_DATA__ -->");let tg=tf+e9.contentHTML+tm;return new ej(await o(a,tg,l,{inAmpMode:eO,hybridAmp:e5}),{metadata:v})}let e1=(e,t,r,n,o)=>e0(e,t,r,n,o,o),e4=w().createContext(null);function e2(e){let t=(0,b.useContext)(e4);t&&t(e)}class e3 extends v{constructor(e){super(e),this.components=e.components}render(e,t,r){return e0(e,t,r.page,r.query,r.renderOpts,{App:this.components.App,Document:this.components.Document})}}let e8={contexts:g},e9=e3})(),module.exports=n})();
