...
class TraceEntryPointsPlugin {
    constructor({ rootDir, appDir, pagesDir, compilerType, optOutBundlingPackages, appDirEnabled, traceIgnores, esmExternals, outputFileTracingRoot, turbotrace, flyingShuttle }){
        ...
        await span.traceChild('create-trace-assets').traceAsyncFn(async ()=>{
            ...
            for (const [entrypoint, entryFiles] of entryFilesMap){
                ...
                if (entrypoint.name.startsWith('app/')) {
                    ...
                    const clientManifestsForPage = entrypoint.name.endsWith('/page') || entrypoint.name === _constants.UNDERSCORE_NOT_FOUND_ROUTE_ENTRY ? _path.default.join(outputPath, outputPrefix, entrypoint.name.replace(/%5F/g, '_') + '_' + _constants.CLIENT_REFERENCE_MANIFEST + '.js') : null;
    ...
    tapfinishModules(compilation, traceEntrypointsPluginSpan, doResolve, readlink, stat) {
        ...
        compilation.hooks.finishModules.tapAsync(PLUGIN_NAME, async (_stats, callback)=>{
            ...
            await finishModulesSpan.traceAsyncFn(async ()=>{
                ...
                const collectDependencies = async (mod)=>{
