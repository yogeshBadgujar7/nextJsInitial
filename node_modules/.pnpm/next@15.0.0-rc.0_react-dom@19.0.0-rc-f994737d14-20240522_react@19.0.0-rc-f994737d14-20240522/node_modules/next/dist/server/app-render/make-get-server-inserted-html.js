...
0 && (module.exports = {
    getTracedMetadata: null,
    makeGetServerInsertedHTML: null
});
...
_export(exports, {
    getTracedMetadata: function() {
        return getTracedMetadata;
    },
    makeGetServerInsertedHTML: function() {
    ...
    return async function getServerInsertedHTML() {
        ...
        const stream = await (0, _serveredge.renderToReadableStream)(/*#__PURE__*/ (0, _jsxruntime.jsxs)(_jsxruntime.Fragment, {
            children: [
                ...
                serverInsertedHTML,
                tracingMetadata ? tracingMetadata.map(({ key, value })=>{
                    return /*#__PURE__*/ (0, _jsxruntime.jsx)("meta", {
                        name: key,
                        content: value
                    }, `next-trace-data-${key}:${value}`);
                }) : null,
                errorMetaTags
            ]
        }), {
