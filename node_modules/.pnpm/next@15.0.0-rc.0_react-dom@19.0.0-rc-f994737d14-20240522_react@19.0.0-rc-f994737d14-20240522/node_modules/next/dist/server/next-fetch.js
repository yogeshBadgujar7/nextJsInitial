...
if (typeof fetch === 'function') {
    ...
    const cachedFetch = function fetch1(resource, options) {
    ...
    try {
        ...
        try {
            ...
            console.warn('Next.js was unable to patch the fetch() function in this environment. ' + 'Suspensey APIs might not work correctly as a result.');
        }
    }
}
